...
public class CorrectnessAnalyzer {
	 ...
	 * @author Jiarui Tian
	 */
	private ArrayList<String> usefulRelativeMutants = new ArrayList<String>();
	//
	...
	public List<String> analyzeAllMutants(SpecificationProvider specs, DataProvider dataSet) {
		...
		for (String mutant : relativelyCorrectMutants) {
			...
			/*
			 * save relativelyCorrectMutants into ArrayList<String>
			 * @author Jiarui Tian
			 */
			usefulRelativeMutants.add(mutant);
			count++;
		}
		System.out.println("\n");
...
//		}
		return relativelyCorrectMutants;
	}
}
