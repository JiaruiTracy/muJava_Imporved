...
public class AORB extends Arithmetic_OP
{
   ...
   public void visit( BinaryExpression p ) throws ParseTreeException 
   {
      ...
      if (isArithmeticType(p))
      {
         ...
         System.out.println();
         System.out.println();
         System.out.println("TTTTTTTTTTTTTEEEEEEEEEEEESSSSSSSSSSSSTTTTTTTTTTT");
         System.out.println(p+" ,"+p.getLeft()+", "+p.getRight()+" ,"+p.getOperator());
         System.out.println("compare 1: "+p.getRight().toString().equals("1"));
   ...
   private void aorMutantGen(BinaryExpression exp, int op)
   {
      ...
      if(exp.getRight().toString().equals("1")){//self modify
    	  ...
    	  if (op != BinaryExpression.TIMES)//if (op != BinaryExpression.TIMES)//
          {
             mutant = (BinaryExpression)exp.makeRecursiveCopy();
   ...
   public void aor_outputToFile(BinaryExpression original, BinaryExpression mutant)
   {
      ...
      String mutant_dir = getMuantID("AORB");//generate AORB_n
